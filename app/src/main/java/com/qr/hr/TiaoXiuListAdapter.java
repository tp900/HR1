...
public class TiaoXiuListAdapter extends BaseAdapter {
    List<TiaoXiuDan> list;
    Context context;
    private int mWidth;
    private int downX= 0;
    private int moveX= 0;
    ...
    public TiaoXiuListAdapter(List<TiaoXiuDan> list,Context context){
    ...
    public int getItemViewType(int position) {
        TiaoXiuDan leave = list.get(position);
    ...
    private void MenuClick(final int position){
        final TiaoXiuDan leave = list.get(position);
        ...
        alertDialog = new AlertDialog.Builder(context)
                ...
                .setPositiveButton("删除", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                String url = "";
                                url = context.getResources().getString(R.string.url) + "CancleLeaveTX";
